                ...
                'Report': function() 
                                    {
                                        ...
                                        window.open(`report.php?${params}&start=${start}&limit=${limit}&sidx=${postData.sidx}&sord=${postData.sord}&global_search=${postData.global_search}&filters=${postData.filters}`)
...
//     // mengambil data dari report.php menggunakan AJAX
//     $.ajax({
//         url: 'report.php',
//         type: 'GET',
//         data: {
...
//             var dataTable = new Stimulsoft.System.Data.DataTable("Data");
//             dataSet.tables.add(dataTable);
//             $.each(data, function(i, item) {
//                 dataTable.rows.add(item.no_invoice, item.tgl_pembelian, item.nama_pelanggan, item.jenis_kelamin, item.saldo);
//             });

//             // membuat laporan PDF menggunakan Stimulsoft
...
// function generateReport(start, end) {
//   $.ajax({
//     url: "report.php", // URL yang akan mengambil data dari server
//     data: {start: start, end: end},
//     dataType: "json",
//     success: function(data) {
//       // Membuat instance Stimulsoft report dan mengambil template dari file .mrt
//       var report = new Stimulsoft.Report.StiReport();
//       report.loadFile("/report/CustomersList.mrt");
      
//       // Membuat data source dengan data yang diperoleh dari server
